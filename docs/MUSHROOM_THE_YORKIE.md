...
Squirrels spawn naturally anywhere the biome already supports rabbits, foxes, wolves, ocelots, pandas, or parrots, including compatible modded biomes, and are also available from a squirrel-specific creative spawn egg. They use normal peaceful-animal ground and light rules and appear in small groups of one to three. A squirrel continually searches for a reachable nearby tree and runs to the closest usable log. Mushroom prioritizes squirrels over ordinary passive animals, barks while chasing for at most 600 game ticks (30 seconds), remembers a squirrel after giving up so he does not immediately restart, and returns to his owner. A squirrel that has not found a tree also ends the chase early if it gets more than 24 blocks from the player. Treats still calm barking at sheep, cows, axolotls, and other passive friends, but do not suppress this deliberately bounded squirrel chase.
